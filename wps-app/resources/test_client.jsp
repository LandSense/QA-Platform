...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				requests[123] = datafolder + "/2.0.0/Completeness.CompletenessCommission2.0.xml";
				requests[124] = datafolder + "/2.0.0/Completeness.CompletenessOmission2.0.xml";
				requests[125] = datafolder + "/2.0.0/Completeness.CompletenessCommissionR2.0.xml";
				requests[126] = datafolder + "/2.0.0/Completeness.CompletenessOmissionR2.0.xml";
				requests[127] = datafolder + "/2.0.0/LogicalConsistency.ConceptualConsistency2.0.xml";
				requests[128] = datafolder + "/2.0.0/LogicalConsistency.ConceptualConsistencyR.2.0.xml";
				requests[129] = datafolder + "/2.0.0/LogicalConsistency.DomainConsistency2.0.xml";
				requests[130] = datafolder + "/2.0.0/LogicalConsistency.TopologicalConsistency2.0.xml";
				requests[131] = datafolder + "/2.0.0/PositionalAccuracy.AbsoluteExternalPositionalAccuracy2.0.xml";
				requests[132] = datafolder + "/2.0.0/PositionalAccuracy.GriddedDataPositionalAccuracy2.0.xml";
				requests[133] = datafolder + "/2.0.0/ThematicAccuracy.NonQuantitativeAttributeAccuracy2.0.xml";
				requests[134] = datafolder + "/2.0.0/ThematicAccuracy.QuantitativeAttributeAccuracy2.0.xml";
				requests[135] = datafolder + "/2.0.0/ThematicAccuracy.ThematicClassificationCorrectness2.0.xml";
				requests[136] = datafolder + "/2.0.0/ThematicAccuracy.ThematicClassificationCorrectnessR2.0.xml";
